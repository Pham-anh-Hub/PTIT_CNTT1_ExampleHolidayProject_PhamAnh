...
export const DEMO_USERS: UserType[] = [
  {
    id: "user-bod",
    username: "admin@goviet.vn",
    fullname: "Phan Văn Hùng",
    role: "BOD / OWNER",
    email: "admin@goviet.vn",
    tenantId: "tenant-1",
  },
  {
    id: "user-hrm",
    username: "hrm@goviet.vn",
  ...
  {
    id: "user-sales",
    username: "sales@goviet.vn",
    fullname: "Trần Minh Tuấn",
    role: "SALES STAFF",
    email: "sales@goviet.vn",
    tenantId: "tenant-1",
  },
  {
    id: "user-worker",
    username: "worker@goviet.vn",
    fullname: "Lê Văn Nam",
    role: "PRODUCTION WORKER",
    email: "worker@goviet.vn",
    tenantId: "tenant-1",
  },
  {
    id: "user-thanglong",
    username: "admin@thanglong.vn",
    fullname: "Nguyễn Văn Thăng",
    role: "BOD / OWNER",
    email: "admin@thanglong.vn",
    tenantId: "tenant-2",
  }
];
...
export default function LoginScreen({ onLoginSuccess }: LoginScreenProps) {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Simulate enterprise standard auth delay
    setTimeout(() => {
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-slate-50 hover:bg-slate-100/30 focus:bg-white text-xs font-medium pl-11 pr-4 py-3.5 rounded-2xl border outline-none transition-all duration-200 ${
                    emailError
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-slate-50 hover:bg-slate-100/30 focus:bg-white text-xs font-medium pl-11 pr-11 py-3.5 rounded-2xl border outline-none transition-all duration-200 ${
                    passwordError
                      ? "border-red-500 focus:border-red-500 focus:ring-1 focus:ring-red-500 bg-red-50/10"
                      : "border-slate-200/80 focus:border-slate-teal"
                  }`}
